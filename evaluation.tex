...
\begin{figure}
    \centering
    \begin{tikzpicture}[y=0.002cm, x=0.3cm]
        %axis
...
\begin{figure}
    \centering
    \begin{tikzpicture}[y=0.002cm, x=0.08cm]
        %axis
        \draw (0,0) -- coordinate (x axis mid) (140,0);
            \draw (0,0) -- coordinate (y axis mid) (0,4000);
            %ticks
            \foreach \x in {0,10,...,140}
                \draw (\x,1pt) -- (\x,-3pt)
                node[anchor=north] {\x};
            \foreach \y in {0,500,...,4000}
                \draw (1pt,\y) -- (-3pt,\y) 
...
\definecolor{RYB2}{RGB}{179, 222, 105}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \begin{axis}[axis lines=middle, 
            ...
            \addplot[RYB1!80!black, mark options={fill=RYB1,color=RYB1}, mark=pentagon*]    file {data/comp_sequential_TermiteSAT.dat};
            \addplot[RYB3!80!black, mark options={fill=RYB3,color=RYB3}, mark=triangle*]    file {data/comp_sequential_SimpleBDDSolverwithAbstraction.dat};
            \addplot[RYB2!80!black, mark options={fill=RYB2,color=RYB2}, mark=halfsquare*]  file {data/comp_sequential_DemiurgeD1real.dat};
            \addplot[RYB4!80!black, mark options={fill=RYB4,color=RYB4}, mark=diamond*]     file {data/comp_sequential_AbsSyntheS3.dat};
            \addplot[RYB5!80!black, mark options={fill=RYB5,color=RYB5}, mark=oplus*]       file {data/comp_sequential_SafetySynth.dat};
            \addplot[RYB6!80!black, mark options={fill=RYB6,color=RYB6}, mark=x]            file {data/comp_sequential_SDF.dat};
