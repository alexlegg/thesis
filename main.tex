...
\begin{abstract}
    ...
    I would also like to thank everyone, past and present, in the Trustworthy Systems group at Data61 for providing an incredibly positive environment for the duration of my PhD. I owe my sanity to the daily coffee outings, the frequent beers, the introduction to climbing, and most importantly the friendships.

    Lastly, for the constant encouragement and support: my parents \textbf{Jon} and \textbf{Kerrie}, my partner \textbf{Edwina}, and my extended family \textbf{Thomas}, \textbf{Kayla}, \textbf{Mary}, \textbf{David}, \textbf{Rachael}, \textbf{Andrew}, \textbf{Kathryn}, and \textbf{Cassandra}.
